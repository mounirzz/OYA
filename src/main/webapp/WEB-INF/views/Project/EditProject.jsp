          ...
          <div class="row">
            ...
            <form:form role="form" action="${ctx}/Projects/add" method="post">
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" name="categorie" class="form-control" value="${Projects.categorie}" required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Add <code>required</code>  Attribuer au champ pour la validation requise.</small></div>
					</div>
					<div class="form-group">
						<h5>Certificat Propriete<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" name="certificat_propriete" class="form-control" value="${Projects.certificat_propriete}" required data-validation-required-message="This field is required"> </div>
					</div>
					<div class="form-group">
						<h5>Description<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="description" name="description" class="form-control" value="${Projects.description}" required data-validation-required-message="This field is required"> </div>
					</div>
							<div class="form-group">
						<h5>Date de début <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="date" name="date_debut" class="form-control" value="${Projects.date_debut}" required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Modifier<code>Champs Obligatoires</code> Attribuer au champ pour la validation requise.</small></div>
							
					</div>
						<div class="form-group">
						<h5>Date de realisation<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="date" name="date_realisation" class="form-control" value="${Projects.date_realisation}" required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Modifier<code>Champs obligatoires</code> Attribuer au champ pour la validation requise.</small></div>
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" name="etat" class="form-control" value="${Projects.etat}"required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Modifier<code>Champs Obligatoires</code>  Attribuer au champ pour la validation requise.</small></div>
					</div>
						<div class="form-group">
						<h5>Inititude <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" name="intitule" class="form-control" value="${Projects.intiutle}" required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Modifier<code>Champs Obligatoires</code>  Attribuer au champ pour la validation requise.</small></div>
					</div>
						<div class="form-group">
						<h5>Numéro Titre Financier <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" name="num_title_foncier" class="form-control" value="${Projects.num_title_foncier}" required data-validation-required-message="This field is required"> </div>
						<div class="form-control-feedback"><small>Modifier<code>Champs Obligatoires</code>  Attribuer au champ pour la validation requise.</small></div>
					</div>
