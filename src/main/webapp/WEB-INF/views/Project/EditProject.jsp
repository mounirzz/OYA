  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Formulaire de projet</li>
      </ol>
    </section>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="categorie" class="form-control required" value="${project.categorie}"> </div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea rows="4" name="description" class="form-control required" value="${project.description}"> </textarea></div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="wdate2">Date de début :</label>
								<input type="date" name="date_debut" class="form-control" value="${project.date_debut}" id="wdate2"> </div>
						</div>
					</div>
					<div class="row">
					<div class="col-md-6">
							<div class="form-group">
								...
								<input type="date" name="date_realisation" class="form-control" value="${project.date_realisation}" id="wdate2"> </div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="wdate2">Etat du projet :</label>
								<input type="text" name="etat" class="form-control" value="${project.etat}" id="wdate2"> </div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="intitule" class="form-control" value="${project.intitule}" id="wdate2"> </div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="wdate2">Numéro Titre Financier :</label>
								<input type="text" name="num_title_foncier" class="form-control" value="${project.num_title_foncier}" id="wdate2"> </div>
						</div>
                		<div class="col-md-6">
                			<div class="form-group">
