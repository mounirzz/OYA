...
<div class="container">
    ...
    <div class="dashboard-content" style="margin-left: 0px;">
        ...
        <div id="titlebar">
			...
			<div class="col-lg-12">
                      <form:form id="inputForm" role="form" action="${ctx}/admin/news/edit"
				...
				<div id="add-listing">
					...
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input class="search-field" minlength="6"  id="title" name="title" type="text" style="color:black;" value="${news.title}"/>
							</div>
						</div>
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="form">
							<h5>Description</h5>
							<textarea class="WYSIWYG" style="color:black;" name="content" cols="40" rows="3" id="summary" spellcheck="true">${news.content}</textarea>
						</div>
