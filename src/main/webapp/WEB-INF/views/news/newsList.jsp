	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2 style="color:white;">Blog</h2><span style="color:Black;">Latest News</span>
...
<div class="container">
  ...
  <c:forEach items="${page.result}" var="news">
			...
			<!-- Blog Post -->
			<div class="blog-post" pid="${news.id}">
				
				<!-- Img 
                <a href="${ctx}/product/${product.id}" class="post-img"><img class="img-thumbnail" src="${ctx}${product.masterPic.url}">		-->
               <a href="${ctx}/news/${news.id}" class="post-img"><img class="img-thumbnail" data-background-image="${ctx}/common/images/blog-post-04.jpg" />
				</a>
				
				<!-- Content -->
				<div class="post-content">
					<h3><a href="${ctx}/news/${news.id}">${news.title}</a></h3>

					<ul class="post-meta">
						<li>August 22, 2017</li>
						<li><a href="#">Tips</a></li>
						<li><a href="#">${news.createTime}</a></li>
					</ul>

					<p>${news.content}</p>

					<a href="${ctx}/news/${news.id}" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
				</div>
