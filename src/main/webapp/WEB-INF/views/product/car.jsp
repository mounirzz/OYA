...
<div class="container">
		...
		<div class="col-lg-9 col-md-8 padding-right-30">
			...
			<img class="img-responsive img-rounded" src="${ctx}${product.masterPic.url}">
				...
				<div class="post-content">
					...
					<ul class="share-buttons margin-top-40 margin-bottom-0">
						<li><a class="fb-share" href="${ctx}/order/ordering/">CREER UNE ALERTE</a></li>
			...
			<div class="about-author">
				...
				<div class="about-description">
					<h4>Tom Perrin</h4>
					<a href="#"><span class="__cf_email__" data-cfemail="cebaa1a38eabb6afa3bea2abe0ada1a3">[email&#160;protected]</span></a>
			...
			<div id="add-review" class="add-review-box">
				...
				<form id="add-comment" class="add-comment">
					<fieldset>
						...
						<div>
							<label>Comment:</label>
							<textarea cols="40" rows="3" style="color: black;"></textarea>
						</div>
		...
		<div class="sidebar right">
			...
			<div class="widget">
				...
				<div class="search-blog-input">
					<div class="input"><input class="search-field" type="text" style="color:black;" placeholder="Type and hit enter" value=""/></div>
				</div>
				<div class="clearfix"></div>
			</div>
			<!-- Widget / End -->
  ...
  <script type="text/javascript" src="${ctx }/common/scripts/maps.js"></script>
