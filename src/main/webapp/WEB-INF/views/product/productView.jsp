...
<head>
	...
	<title> ${product.title} Autocar ATRIEM FRANCE</title>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div class="boxed-widget opening-hours summary margin-top-0">
				...
				<ul>
					...
					<li class="total-costs"> <c:choose>
					    <c:when test="${not empty login_admin}">
					
						<span>
					<a href="${ctx}/admin/product/edit/${product.id}" style="margin: 5px 58px;width: 186px;padding: 9px 65px;" class="button border with-icon">Modifier</a>
					</span>
