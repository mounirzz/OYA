...
<div class="content-wrapper" style="min-height: 1923.5px;">
    ...
    <section class="content-header">
      <h1>
        ${client.project.categorie} </h1><div class="col-lg-6 col-12" style=" width: 30%;  max-width: 30%; margin-left: 523px; margin-top: -39px;"> <div class="box-body pad res-tb-block"> <div class="alert alert-warning alert-dismissable">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">${client.project.categorie}</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-3 col-12">
          ...
          <!--  -->    <img class="profile-user-img rounded-circle img-fluid mx-auto d-block" src="${ctx}${client.ClientPic.url}" width="150" style=" background-color: rgb(255, 255, 255);border-radius: 0% ! important;">
              ...
              <div class="row">
              	<div class="col-12">
              		<div class="profile-user-info">
						<p><i class="fa fa-envelope pr-15"></i>${client.mail}</p>
						<p><i class="fa fa-phone pr-15"></i>${client.tel}</p>
						<p><i class="fa fa-map-marker pr-15"></i>${client.adresse} - ${client.fax}</p>
...
Bommerang Communications provides first rate telecommunication solutions to help keep your business running smoothly. We pride ourselves on expert advice, unbeatable service and the latest products, backed up with helpful support when you need it most.					  </p>
              ...
              <div class="tab-pane active show" id="project">
                <form:form class="form-horizontal form-element col-12" action="${ctx}/project/edit">
                  <div class="form-group row">
                    <label for="inputName" class="col-sm-2 control-label">Catégorie</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" value="${client.project.categorie}"    placeholder="">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputPhone" value="${client.project.date_debut}"  placeholder="">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputExperience"   value="${client.project.description}" placeholder=""></input>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" value="${client.project.etat}"  placeholder="">
                    </div>
                  </div>
                              <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" value="${client.project.intitule}"  placeholder="">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" value="${client.project.num_title_foncier}"  placeholder="">
                    </div>
                  </div>
                      <div class="form-group row">
                    <label for="inputSkills" class="col-sm-2 control-label">Titre foncier</label>
                  ...
                  <div class="col-md-5 text-center">
              		  <img class="img-responsive img-rounded" src="${ctx}${client.project.ProjectPic.url}">
          				  </div>
          		</div>
                  <!--  <div class="form-group row">
