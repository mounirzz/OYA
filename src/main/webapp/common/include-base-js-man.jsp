...
<script type="text/javascript" src="${ctx}/common/scripts/jquery/dist/jquery.min.js"></script>
	...
	<!-- Bootstrap 4.0-->
	<script src="${ctx}/common/scripts/bootstrap/dist/js/bootstrap.js"></script>
	
	<!-- Bootstrap WYSIHTML5 -->
	<script src="${ctx}/common/scripts/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.js"></script>
	...
	<!-- webticker -->
	<script src="${ctx}/common/scripts/Web-Ticker-master/jquery.webticker.min.js"></script>
	
	<!-- EChartJS JavaScript -->
	<script src="${ctx}/common/scripts/echarts-master/dist/echarts-en.min.js"></script>
	<script src="${ctx}/common/scripts/echarts-liquidfill-master/dist/echarts-liquidfill.min.js"></script>
	...
	<script src="${ctx}/common/js/dashboard.js"></script>
	<script src="${ctx}/common/js/dashboard-chart.js"></script>
    ...
    <script src="${ctx}/common/scripts/sweetalert/jquery.sweet-alert.custom.js"></script>
