      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/images/user-thumbnail.png" class="user-image rounded-circle" alt="User Image">
            </a>
            <ul class="dropdown-menu scale-up">
              <!-- User image -->
              <li class="user-header">
                <img src="/images/user-thumbnail.png" class="float-left rounded-circle" alt="User Image">

                <p>
                  ${login_user.username}
                  <small class="mb-5">${user.slat}</small>
              ...
              <li class="user-body">
                <div class="row no-gutters">
                  <div class="col-12 text-left">
                    <a href="${ctx}/user/profile"><i class="ion ion-person"></i> My Profile</a>
                  </div>
                  <div class="col-12 text-left">
                    <a href="#"><i class="ion ion-email-unread"></i> Inbox</a>
                  </div>
                  <div class="col-12 text-left">
                    <a href="${ctx}/user/profile"><i class="ion ion-settings"></i> Setting</a>
                  </div>
          ...
          <li>
            <a href="#" data-toggle="control-sidebar control-sidebar-fa"><i class="fa fa-cog fa-spin"></i></a>
          </li>
        </ul>
      </div>
    </nav>
