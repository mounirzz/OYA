    ...
    <form:form cssClass="form-horizontal" action="${ctx}/order/ordering" method="post">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-2 control-label">Téléphone</label>
                ...
                <div class="form-group">
                    <label for="consignee" class="col-sm-2 control-label">Personne de contact</label>
                    <div class="col-sm-6">
...
                     <td>quantité</td>
            ...
            <a class="btn btn-primary" href="${ctx}/cart/">Retour au panier</a>
            <button class="btn btn-primary" type="submit" href="${ctx}/order/ordering/">Confirmation</button>

            <div id="delSuccess" class="alert alert-success" style="display: none;">Supprimé avec succès</div>
            <div id="delAllSuccess" class="alert alert-success" style="display: none;">Panier éliminé ...</div>
        </div>
    </form:form>
</div>
