...
<head>
    ...
    <title>Liste des marchandises</title>
    ...
    <div class="row">
        <c:forEach items="${page.result}" var="product">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 text-center">
                ...
                <p>
                    <a class="btn btn-info" href="${ctx}/product/${product.id}" role="button">Voir </a>
                    <a class="btn btn-primary addCart" productid="${product.id}" role="button">Acheter</a>
                </p>
            </div>
        </c:forEach>
    </div>
